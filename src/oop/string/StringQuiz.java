...
public class StringQuiz {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         031225-3456789 -> 2003년 11월 25일 21세 남자
         031225-4123456 -> 2003년 11월 25일 21세 여자
        ...
        */
        ...
        while (true) {
            ...
            ssn = ssn.replace("-", "");
            char c = ssn.charAt(6); // 주민등록번호 뒷자리 첫 번째 숫자
            String str = ssn.substring(0, 2);
            int year = Integer.parseInt(str); // 연도를 정수로 변환.
            String month = ssn.substring(2, 4); // 월
            String day = ssn.substring(4, 6); // 일
