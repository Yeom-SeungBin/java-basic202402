...
public class Main {
	...
	public static void main(String[] args) {
		...
		// 선언부에 추상 메서드 오버라이딩을 즉시 선언하여 사용합니다.
		...
		// 어차피 filterApple의 두 번째 매개값은 무조건 ApplePredicate 타입의 객체가 전달되어야 하는거고,
		// ApplePredicate는 추상 메서드가 하나니까 굳이 메서드 이름을 쓸 필요가 없는거지.
		...
		// 매개변수가 없거나, 두 개 이상일 경우에는 소괄호 꼭 붙여야 합니다.
